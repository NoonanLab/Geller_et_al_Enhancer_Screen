...
#import mageck biological effects rep 2
S01 <- read.table("/Users/evangeller/Desktop/enhancer_analysis/mageck/beta/S01_NTC_rep2.gene_summary.txt", header= T)
S02 <- read.table("/Users/evangeller/Desktop/enhancer_analysis/mageck/beta/S02_NTC_rep2.gene_summary.txt", header= T)
S03 <- read.table("/Users/evangeller/Desktop/enhancer_analysis/mageck/beta/S03_NTC_rep2.gene_summary.txt", header= T)
S04 <- read.table("/Users/evangeller/Desktop/enhancer_analysis/mageck/beta/S04_NTC_rep2.gene_summary.txt", header= T)
S05 <- read.table("/Users/evangeller/Desktop/enhancer_analysis/mageck/beta/S05_NTC_rep2.gene_summary.txt", header= T)
S06 <- read.table("/Users/evangeller/Desktop/enhancer_analysis/mageck/beta/S06_NTC_rep2.gene_summary.txt", header= T)
S07 <- read.table("/Users/evangeller/Desktop/enhancer_analysis/mageck/beta/S07_NTC_rep2.gene_summary.txt", header= T)
S08 <- read.table("/Users/evangeller/Desktop/enhancer_analysis/mageck/beta/S08_NTC_rep2.gene_summary.txt", header= T)
...
write.table(output, "/Users/evangeller/Desktop/enhancer_analysis/mageck/S0X_mageck_annotate_rep2.txt", row.names=F, sep=" ", quote= F)
