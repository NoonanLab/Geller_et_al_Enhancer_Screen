...
#import mageck biological effects rep 1
S01 <- read.table("/Users/evangeller/Desktop/enhancer_analysis/mageck/beta/S01_NTC_rep1.gene_summary.txt", header= T)
S02 <- read.table("/Users/evangeller/Desktop/enhancer_analysis/mageck/beta/S02_NTC_rep1.gene_summary.txt", header= T)
S03 <- read.table("/Users/evangeller/Desktop/enhancer_analysis/mageck/beta/S03_NTC_rep1.gene_summary.txt", header= T)
S04 <- read.table("/Users/evangeller/Desktop/enhancer_analysis/mageck/beta/S04_NTC_rep1.gene_summary.txt", header= T)
S05 <- read.table("/Users/evangeller/Desktop/enhancer_analysis/mageck/beta/S05_NTC_rep1.gene_summary.txt", header= T)
S06 <- read.table("/Users/evangeller/Desktop/enhancer_analysis/mageck/beta/S06_NTC_rep1.gene_summary.txt", header= T)
S07 <- read.table("/Users/evangeller/Desktop/enhancer_analysis/mageck/beta/S07_NTC_rep1.gene_summary.txt", header= T)
S08 <- read.table("/Users/evangeller/Desktop/enhancer_analysis/mageck/beta/S08_NTC_rep1.gene_summary.txt", header= T)
...
S07_map <- import.bed("/Users/evangeller/Desktop/enhancer_analysis/mageck/lib/S07_lib.map")
S08_map <- import.bed("/Users/evangeller/Desktop/enhancer_analysis/mageck/lib/S08_lib.map")
...
S0X_mageck[(S0X_mageck$spec_control == 1) & (S0X_mageck$t4.p.value == 0)]$t4.p.value <- 1 / (10*length(unique(S04_mageck$name)))
S0X_mageck[(S0X_mageck$spec_control == 1) & (S0X_mageck$t8.p.value == 0)]$t8.p.value <- 1 / (10*length(unique(S04_mageck$name)))
S0X_mageck[(S0X_mageck$spec_control == 1) & (S0X_mageck$t12.p.value == 0)]$t12.p.value <- 1 / (10*length(unique(S04_mageck$name)))
...
output <- as.data.frame(S0X_mageck, row.names = NULL)


write.table(output, "/Users/evangeller/Desktop/enhancer_analysis/mageck/S0X_mageck_annotate_rep1.txt", row.names=F, sep=" ", quote= F)
